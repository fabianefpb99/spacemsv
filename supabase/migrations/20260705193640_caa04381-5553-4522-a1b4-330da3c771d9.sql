CREATE OR REPLACE FUNCTION public.spin_slot_samurai_v1(
  p_user_id uuid,
...
BEGIN
  ...
  INSERT INTO public.transactions (
    ...
    p_user_id, 'bet'::transaction_type, -p_bet_amount, v_new_balance, 'slot_samurai', p_client_action_id,
    jsonb_build_object(
      'kind',             'slot_samurai_bet',
  ...
  IF v_total > 0 THEN
    ...
    INSERT INTO public.transactions (
      ...
      p_user_id, 'win'::transaction_type, v_total, v_new_balance, 'slot_samurai', NULL,
      jsonb_build_object(
        'kind', 'slot_samurai_win', 'bet_tx_id', v_bet_tx_id,
...
REVOKE EXECUTE ON FUNCTION public.spin_slot_samurai_v1(uuid, numeric, uuid) FROM PUBLIC, anon;
GRANT  EXECUTE ON FUNCTION public.spin_slot_samurai_v1(uuid, numeric, uuid) TO authenticated, service_role;

INSERT INTO public.game_rtp_config (game, rtp_target, rtp_baseline, is_active)
VALUES ('slot_samurai', 94.50, 94.50, true)
