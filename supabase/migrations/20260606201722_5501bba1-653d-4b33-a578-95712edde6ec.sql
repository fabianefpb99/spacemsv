...
DECLARE
  ...
  -- Base pool (rank 1 = favorito). El perm asigna qué rank recibe cada char.
...
BEGIN
  ...
  -- Validar permutación: 4 enteros, cada uno en 1..4, todos distintos.
  ...
  -- Asignar pesos y odds por personaje según permutación.
  v_weights := ARRAY[
