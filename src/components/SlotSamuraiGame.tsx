...
export function SlotSamuraiGame() {
  ...
  return (
    <div
      className="relative flex h-[var(--app-h,100dvh)] flex-col overflow-hidden text-white [@media(max-height:720px)]:h-auto [@media(max-height:720px)]:min-h-[100dvh] [@media(max-height:720px)]:overflow-y-auto"
      style={{
