  ...
  return (
    ...
    >
      <img
        ...
        draggable={false}
      />
      <span className="brand-loader-reveal absolute bottom-8 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 text-[10px] font-medium tracking-wide text-white/80">
