...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BETSPACE - Casino" },
      { name: "description", content: "BETSPACE - Apuesta y gana desde tu telefono, tus juegos favoritos en un solo lugar. Casino Online BETSPACE" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "BETSPACE - Casino" },
      { property: "og:description", content: "BETSPACE - Apuesta y gana desde tu telefono, tus juegos favoritos en un solo lugar. Casino Online BETSPACE" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "BETSPACE - Casino" },
      { name: "twitter:description", content: "BETSPACE - Apuesta y gana desde tu telefono, tus juegos favoritos en un solo lugar. Casino Online BETSPACE" },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('betspace-theme');if(t!=='light'&&t!=='dark')t='dark';document.documentElement.classList.add(t);}catch(e){document.documentElement.classList.add('dark');}})();`,
          }}
        />
      </head>
      <body>
