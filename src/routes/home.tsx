        ...
        <div className="relative mt-3 block h-24 overflow-hidden rounded-xl border border-amber-400/70 shadow-[0_0_12px_rgba(251,191,36,0.3)] transition hover:shadow-[0_0_22px_rgba(251,191,36,0.6)] sm:h-28">
          ...
          <div className="relative z-10 flex h-full items-center justify-between gap-3 px-4 sm:px-5">
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 inline-block rounded-sm bg-amber-500/80 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-black shadow-[0_0_8px_rgba(251,191,36,0.6)]">
                Premio acumulado
              </div>
            </div>
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-amber-400/70 bg-black/50 text-amber-100 backdrop-blur-sm shadow-[0_0_10px_rgba(251,191,36,0.5)]">
              <ChevronRight className="h-4 w-4" />
            </span>
          </div>
        </div>
