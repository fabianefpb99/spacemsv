...
const MISSIONS: Mission[] = [
  {
    ...
    progress: 6,
    goal: 10,
    reward: { kind: "bonus", value: 5000, label: "5.000 Bonus" },
  ...
  },
  {
    ...
    progress: 3,
    goal: 10,
    reward: { kind: "spins", value: 10, label: "10 Free Spins" },
  ...
  },
  {
    ...
    progress: 1,
    goal: 3,
    reward: { kind: "bonus", value: 10000, label: "10.000 Bonus" },
    cta: { label: "Ir a Arena", to: "/arena" },
    accent: "rose",
  ...
  },
  {
    ...
    progress: 12500,
    goal: 50000,
    reward: { kind: "bonus", value: 7500, label: "7.500 Bonus" },
